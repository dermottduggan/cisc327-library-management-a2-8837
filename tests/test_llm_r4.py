...
from library_service import return_book_by_patron, update_book_availability, update_borrow_record_return_date, calculate_late_fee_for_book
...
def test_return_book_success(monkeypatch):
    ...
    monkeypatch.setattr("library_service.update_book_availability", lambda bid, val: True)
    monkeypatch.setattr("library_service.update_borrow_record_return_date", lambda pid, bid, date: True)
...
def test_return_book_with_late_fee(monkeypatch):
    ...
    monkeypatch.setattr("database.get_patron_borrowed_books", lambda pid: fake_books)
    monkeypatch.setattr("library_service.calculate_late_fee_for_book", lambda pid, bid: {"fee_amount": 15})
    monkeypatch.setattr("library_service.update_book_availability", lambda bid, val: True)
    monkeypatch.setattr("library_service.update_borrow_record_return_date", lambda pid, bid, date: True)
...
def test_return_book_update_failure(monkeypatch):
    ...
    monkeypatch.setattr("database.get_patron_borrowed_books", lambda pid: fake_books)
    monkeypatch.setattr("library_service.calculate_late_fee_for_book", lambda pid, bid: {"fee_amount": 0})
    monkeypatch.setattr("library_service.update_book_availability", lambda bid, val: False)
